...
export const products = [
...

  {
    ...
    challengeImg: datadrive,
    header2:
      "Meet Nudge - Your Proactive Partner in Talent Actioning",
    tag2: "Nudge takes a different approach. Rather than focusing on limited metrics to draw insights, it ingests your entire org data and automatically identifies the metrics you should track. You can further customize them and add tripwires as per your operating landscape and organization realities. No more guessing or waiting for dashboards to load. Nudge alerts the right stakeholders the moment something goes off track, explaining what’s wrong, why it’s happening, and what actions to take. So rather than look for insights in the heap of data, let data guide you to insights actions.",
    productFeatures: [
      {
      ...
      },
      {
        ...
        toggle: true,
        desc: "Nudge ensures you act at the right time, every time without missing any critical event",
        demoLink: "",
        img: datadriveimg,
      },
      {
